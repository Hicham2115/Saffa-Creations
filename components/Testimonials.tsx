...
export function Testimonials() {
  return (
    <section className="bg-[#faf5ec] px-6 py-20 sm:px-10 sm:py-28">
      <ScrollReveal className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-6 text-stone-600">
          Hear from our customers who have made Saffa Creations a part of their
          most beautiful moments.
        </p>
      </ScrollReveal>

      <div className="mx-auto mt-14 grid max-w-6xl grid-cols-1 gap-6 sm:grid-cols-3">
        {testimonials.map(({ quote, name, location, photo }, index) => (
          <ScrollReveal key={name} delay={index * 0.1}>
            <div className="flex h-full flex-col items-center rounded-2xl border border-stone-200 bg-white px-8 py-10 text-center">
              <span
                className="font-heading text-4xl leading-none text-amber-600/70"
                aria-hidden="true"
              >
                &ldquo;
              </span>
              ...
              <span
                className="mt-6 block h-px w-8 bg-amber-600/40"
                aria-hidden="true"
              />
              ...
              <div className="mt-6 flex flex-col items-center">
                ...
                <h3 className="mt-3 font-heading text-lg text-stone-900">
                  {name}
                </h3>
