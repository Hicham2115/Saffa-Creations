  ...
  return (
    <section className="bg-[#f7f3ec] px-6 py-20 sm:px-10 sm:py-28">
      <div className="mx-auto max-w-3xl text-center">
        <div className="text-xs tracking-[0.3em] text-[#c8a078]">
          WHY CHOOSE US
        </div>
        ...
        <span
          className="mx-auto mt-6 block h-px w-10 bg-[#c8a078]/60"
          aria-hidden="true"
        />
      ...
      <div className="mx-auto mt-14 grid max-w-6xl grid-cols-1 divide-y divide-stone-200 bg-[#faf7f2] sm:grid-cols-2 sm:divide-x sm:divide-y-0 lg:grid-cols-4">
        {mainFeatures.map(({ title, description, icon: Icon }) => (
          ...
          >
            <div className="flex h-24 w-24 items-center justify-center rounded-full bg-[#f3ece0] transition-colors duration-300 group-hover:bg-[#c8a078]">
              <Icon
                className="h-9 w-9 text-[#c8a078] transition-colors duration-300 group-hover:text-white"
                strokeWidth={1.25}
                aria-hidden="true"
              />
            </div>
            <h3 className="mt-6 font-heading text-xl text-stone-900 transition-colors duration-300 group-hover:text-[#c8a078]">
              {title}
            </h3>
            <span
              className="mt-3 block h-px w-6 bg-[#c8a078]/60 transition-all duration-300 group-hover:w-10"
              aria-hidden="true"
            />
      ...
      {/* <div className="mx-auto mt-14 grid max-w-6xl grid-cols-1 gap-y-10 sm:grid-cols-2 sm:divide-x sm:divide-stone-200 lg:grid-cols-4">
        {extraFeatures.map(({ title, description, icon: Icon }) => (
          <div key={title} className="flex items-start gap-4 px-2 sm:px-6">
            <Icon
              className="h-8 w-8 shrink-0 text-[#c8a078]"
              strokeWidth={1.25}
              aria-hidden="true"
            />
            <div>
